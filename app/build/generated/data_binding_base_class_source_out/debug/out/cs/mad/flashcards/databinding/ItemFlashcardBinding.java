...
public final class ItemFlashcardBinding implements ViewBinding {
  ...
  private ItemFlashcardBinding(@NonNull TextView rootView, @NonNull TextView flashcardTitle) {
  ...
  public static ItemFlashcardBinding bind(@NonNull View rootView) {
    ...
    TextView flashcardTitle = (TextView) rootView;

    return new ItemFlashcardBinding((TextView) rootView, flashcardTitle);
  }
}
