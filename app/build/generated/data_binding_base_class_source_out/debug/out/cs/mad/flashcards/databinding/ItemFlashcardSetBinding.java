...
public final class ItemFlashcardSetBinding implements ViewBinding {
  ...
  private ItemFlashcardSetBinding(@NonNull FrameLayout rootView,
      @NonNull TextView flashcardSetTitle) {
  ...
  public static ItemFlashcardSetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFlashcardSetBinding((FrameLayout) rootView, flashcardSetTitle);
    }
