...
public final class ActivityLocalWeatherBinding implements ViewBinding {
  ...
  private ActivityLocalWeatherBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull TextView jsonView) {
  ...
  public static ActivityLocalWeatherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.json_view;
      TextView jsonView = rootView.findViewById(id);
      if (jsonView == null) {
        break missingId;
      }

      return new ActivityLocalWeatherBinding((LinearLayoutCompat) rootView, jsonView);
    }
